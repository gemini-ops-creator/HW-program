...
function HomePage() {
    return (
        <div className={styles.homeContainer}>
            <Header />
            <main className={styles.heroSection} style={{ backgroundImage: `url(${bgShape})` }}>
                <div className={styles.heroBanner}>
                    <div className={styles.heroLeftSide}>
                        <h1 className={styles.mainTitle}>
                            ...
                            <div>& takeaway,</div>
                            <div>
                                <span className={styles.highlightText}>delivered</span> to your door.
                            </div>
                        </h1>
                        ...
                        <div className={styles.ratingArea}>
                            <img src={trustpilotImage} alt="Review Platform Logo" className={styles.reviewLogo} />
                            <div className={styles.reviewStats}>
                                ...
                                <span className={styles.ratingText}>from over 2000+ reviews</span>
                            </div>
                        </div>
                    </div>
                    <div className={styles.heroRightSide}>
                        <img src={heroImage} alt="Delicious Food" className={styles.foodImage} />
                    </div>
                </div>
            </main>
            <Footer />
